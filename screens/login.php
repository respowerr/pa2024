...
<head>
    ...
    <title>Connexion - Au temps Donné</title>
...
<div class="container mx-auto flex-grow flex justify-center items-center">
    <div class="bg-white p-8 rounded shadow-md w-full sm:w-96">
        ...
        <form action="#" method="POST">
            ...
            <button type="submit" class="bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700 transition-colors duration-200">Se connecter</button>
        </form>
    </div>
</div>
